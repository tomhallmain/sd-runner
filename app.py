...
#        self.apply_to_grid(self.dress_chance_box, sticky=E, interior_column=2, column=1, increment_row_counter=True)

        self.expressions_var = BooleanVar(value=prompter_config.expressions)
