...
class TimedSchedule:
    ...
    def set_start_time(self, hour=0, minute=0):
        self.start_time = TimedSchedule.get_time(hour=hour, minute=minute)

    def set_end_time(self, hour=0, minute=0):
        self.end_time = TimedSchedule.get_time(hour=hour, minute=minute)

    def set_shutdown_time(self, hour=0, minute=0):
        self.shutdown_time = TimedSchedule.get_time(hour=hour, minute=minute)
    ...
    def __eq__(self, other: object) -> bool:
        return isinstance(other, TimedSchedule) and self.name == other.name
